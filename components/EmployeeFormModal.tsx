    ...
    if (isOpen) {
      if (initialData) {
        reset({
          ...
          dateHired: initialData.dateHired ? new Date(initialData.dateHired).toISOString().split('T')[0] : '',
      ...
      <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4">
        ...
        <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg border border-gray-100">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Upload a professional photo (JPG, PNG). Max 2MB.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-12 gap-3">
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <input {...register('middleName')} className="input-field" placeholder="e.g. M." />
            </div>
            <div className="col-span-12 md:col-span-4">
            ...
            <div className="col-span-12 md:col-span-6">
               ...
               <input {...register('contactNo')} className={`input-field ${errors.contactNo ? 'border-red-500' : ''}`} placeholder="09xxxxxxxxx" />
               {errors.contactNo && <span className="text-xs text-red-500 mt-1">{errors.contactNo.message}</span>}
            </div>
          ...
          <div className="grid grid-cols-12 gap-3">
            <div className="col-span-12 md:col-span-6">
              ...
              <div className="relative">
                <select 
                  {...register('position')} 
                  className={`input-field appearance-none ${errors.position ? 'border-red-500' : ''}`}
                  onChange={(e) => {
                    register('position').onChange(e);
                    const selectedPos = e.target.value;
                    const deptEntry = Object.entries(POSITION_DEPARTMENT_MAP).find(([_, positions]) => 
                      positions.includes(selectedPos)
                    );
                    if (deptEntry) {
                ...
                >
                  ...
                  {Object.entries(POSITION_DEPARTMENT_MAP).map(([dept, positions]) => (
            ...
            <div className="col-span-12 md:col-span-6">
              ...
              <div className="relative">
                <select {...register('department')} className="input-field appearance-none bg-gray-50" readOnly>
        ...
        <div>
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                ...
                <h4 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Government IDs</h4>
            </div>
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 md:col-span-6">
        ...
        <div>
            <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
                <AlertCircle size={16} className="text-primary-500" />
                <h4 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Emergency Contact</h4>
            </div>
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-12 md:col-span-5">
                    <label className="label-text">Full Name</label>
                    <input {...register('ecFullName')} className={`input-field ${errors.ecFullName ? 'border-red-500' : ''}`} />
                    {errors.ecFullName && <span className="text-xs text-red-500 mt-1">{errors.ecFullName.message}</span>}
                </div>
                <div className="col-span-12 md:col-span-4">
                    <label className="label-text">Contact No.</label>
                    <input {...register('ecContactNumber')} className={`input-field ${errors.ecContactNumber ? 'border-red-500' : ''}`} />
                    {errors.ecContactNumber && <span className="text-xs text-red-500 mt-1">{errors.ecContactNumber.message}</span>}
                </div>
                <div className="col-span-12 md:col-span-3">
                    ...
                    {errors.ecRelationship && <span className="text-xs text-red-500 mt-1">{errors.ecRelationship.message}</span>}
                </div>
            </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-12 gap-3">
            <div className="col-span-12 md:col-span-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className={`input-field font-mono flex-1 ${errors.basicSalary ? 'border-red-500' : ''}`}
                  placeholder="0.00"
                />
              </div>
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <p className="text-xs text-gray-400 mt-1">22 working days/month</p>
            </div>
